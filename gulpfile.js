...
gulp.task('build', gulp.series('clean', gulp.parallel('sass', 'webpack'), 'images', 'fonts', 'copy'));

gulp.task('build-production', gulp.series('clean', gulp.parallel('styles', 'scripts'), 'images', 'fonts', 'copy'));
